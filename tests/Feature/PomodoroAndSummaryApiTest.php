...
class PomodoroAndSummaryApiTest extends TestCase
{
    ...
    public function test_user_can_store_and_read_pomodoro_history(): void
    {
        ...
        $store->assertCreated()
            ...
            ->assertJsonPath('data.session.duration', '00:25:00');
        ...
        $history->assertOk()
            ...
            ->assertJsonPath('data.sessions.0.duration_seconds', 1500);
    }
    ...
    public function test_user_can_generate_summary_via_api(): void
    {
        ...
        $response->assertOk()
            ->assertJsonPath('success', true)
            ->assertJsonPath('data.summary.status', 'success')
            ->assertJsonPath('data.summary.output.0', '- poin pertama');
    }
}
